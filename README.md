...
-> Script que faz a instalação do Zabbix Agent em sistemas Debian: [InstalaçãoZabbixAgent](https://github.com/amaurybsouza/Shell-Script/blob/master/CursoShellScript/ScriptsAmaury/InstalacaoZabbixAgent.sh)
